...
| **Sprint 2** | Maio/Junho | **Design & Modelo** | Prototipagem de interfaces e definição de variáveis para o modelo atuarial.                     |
...
- `Sompo - Solução Campo Seguro.pdf`: Documentação completa e visualmente formatada da solução (contexto, detalhes técnicos, arquitetura, estrutura de dados, personas, plano de entregas e referências)
- `Campo Seguro - Sprint 1 - Apresentação.pdf`: Apresentação utilizada para criação do Vídeo Demonstrativo
